...
public class MqttService
{
    ...
    private bool _isFirstMessageIgnored;
        ...
        if (_client.IsConnected())
        {
            try
            {
                ...
                if (!_isSubscribed)
                {
                    ...
                    {
                        if (!_isFirstMessageIgnored)
                        {
                            _isFirstMessageIgnored = true;
                            Console.WriteLine("Primeira mensagem ignorada.");
                            return;
                        }
